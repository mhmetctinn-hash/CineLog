...
export function Logo() {
  return (
    <Link to="/" className="logo-mark group select-none">
      <span className="logo-shine-viewport inline-flex items-center gap-2 pb-3 -mb-3">
        ...
        {/* single light sheen sweeping across the icon + wordmark together */}
